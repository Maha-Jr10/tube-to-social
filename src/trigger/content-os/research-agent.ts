...
import type { ResearchAgentInput, KnowledgeBase, CoreIdea, Framework, Story, Quote } from "../../lib/types.js";
...
export const researchAgent = task({
  ...
  run: async (payload: ResearchAgentInput): Promise<KnowledgeBase> => {
...
Only extract information present in the transcript. Do not invent facts.`;
    ...
    const raw = await callClaudeJson<ClaudeKBOutput>(system, user);
