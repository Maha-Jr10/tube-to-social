...
// src/lib/claude.ts
var OPENROUTER_MODEL = process.env.OPENROUTER_MODEL ?? "google/gemma-4-31b-it:free";
function getClient() {
...
__name(callClaudeJson, "callClaudeJson");

export {
  callClaudeJson
};
//# sourceMappingURL=chunk-PZR6WYVR.mjs.map
